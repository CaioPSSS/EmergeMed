const { getCurrentLevelInfo, LEVEL_THRESHOLDS, ACHIEVEMENTS } = require('../dist-cjs/gamification-engine.js');
const { deriveAllTopicMetrics } = require('../dist-cjs/learning-engine.js');
const { CHAPTERS_DATA } = require('../dist-cjs/chapters-data.js');
const { LEARNING_TRACKS } = require('../dist-cjs/learning-tracks.js');

console.log('====================================================');
console.log('EMPIRICAL VERIFICATION HARNESS — M5 & M6 (CJS)');
console.log('====================================================\n');
