...
exports.DEFAULT_CHAPTER_WEIGHTS = void 0;
exports.getChapterWeight = getChapterWeight;
exports.DEFAULT_CHAPTER_WEIGHTS = [
...
function getChapterWeight(chapterId) {
    return (exports.DEFAULT_CHAPTER_WEIGHTS.find(function (w) { return w.chapterId === chapterId; }) || {
        chapterId: chapterId,
        frequencyScore: 5.0,
        importanceScore: 5.0,
        category: 'Geral',
